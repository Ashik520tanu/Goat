        ...
        switch (logMessageType) {
            case "log:thread-admins": {
                if (logMessageData.ADMIN_EVENT == "add_admin") {
                    ...
                    if (global.configModule[this.config.name].sendNoti) api.sendMessage(`»» NOTICE «« Update user ${logMessageData.TARGET_ID} এই নে বলদ তোরে গ্রুপে এড়মিন দিলাম 😁🫵🏾\n\nwlc to admin slot\n\nhopy you will serve your best\n\nযদি ভালোভাবে না থাকোস তাইলে তরে লাথি দিয়ে রিমুভ দেব`, threadID, async (error, info) => {
