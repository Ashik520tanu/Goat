				      			...
				      			const type = (event.author == event.logMessageData.leftParticipantFbId) ? "leave" : "managed";
				      				const path = join(__dirname, "events", "123.mp4");
				      					const pathGif = join(path, `${threadID}123.mp4`);
				      						var msg, formPush
	if (existsSync(path)) mkdirSync(path, { recursive: true });
(typeof data.customLeave == "undefined") ? msg = "╭═════⊹⊱✫⊰⊹═════╮ \n ⚠️ notice ⚠️\n╰═════⊹⊱✫⊰⊹═════╯\n\n{session}||{name} তোর মতো আবাল...\nএই মাত্র গ্রুপে না থাকলে\nগ্রুপের বাল ও ছেড়া যাবে না\nযা ভাগ এনতে নলা...\n\n— @everyon\n🚫গ্রুপের নিয়ম না মানলে কিক✅| \n\n⏰ তারিখ ও সময়: {time}\n⚙️ স্ট্যাটাস: {type} (মনে থাকে যেনো সবার)\n\✍হাওয়ার পো গেছে ভালো হইছে?" : msg = data.customLeave;
